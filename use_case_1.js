...
describe('parser', function() {
  ...
  it("passes the second example", function() {
    var str = ["                           ",
               "  |  |  |  |  |  |  |  |  |",
               "  |  |  |  |  |  |  |  |  |"];

    assert.deepEqual(parser(str), [1,1,1,1,1,1,1,1,1]);
  });

  it("passes the third example", function() {
    var str = [" _  _  _  _  _  _  _  _  _ ",
               " _| _| _| _| _| _| _| _| _|",
               "|_ |_ |_ |_ |_ |_ |_ |_ |_ "];

    assert.deepEqual(parser(str), [2,2,2,2,2,2,2,2,2]);
  });

  it("passes the fourth example", function() {
    var str = [" _  _  _  _  _  _  _  _  _ ",
               " _| _| _| _| _| _| _| _| _|",
               " _| _| _| _| _| _| _| _| _|"];

    assert.deepEqual(parser(str), [3,3,3,3,3,3,3,3,3]);
  });

  it("passes the 5th example", function() {
    var str = ["                           ",
               "|_||_||_||_||_||_||_||_||_|",
               "  |  |  |  |  |  |  |  |  |"];

    assert.deepEqual(parser(str), [4,4,4,4,4,4,4,4,4]);
  });

  it("passes the 6th example", function() {
    var str = [" _  _  _  _  _  _  _  _  _ ",
               "|_ |_ |_ |_ |_ |_ |_ |_ |_ ",
               " _| _| _| _| _| _| _| _| _|"];

    assert.deepEqual(parser(str), [5,5,5,5,5,5,5,5,5]);
  });

  it("passes the 7th example", function() {
    var str = [" _  _  _  _  _  _  _  _  _ ",
               "|_ |_ |_ |_ |_ |_ |_ |_ |_ ",
               "|_||_||_||_||_||_||_||_||_|"];

    assert.deepEqual(parser(str), [6,6,6,6,6,6,6,6,6]);
  });

  it("passes the 8th example", function() {
    var str = [" _  _  _  _  _  _  _  _  _ ",
               "  |  |  |  |  |  |  |  |  |",
               "  |  |  |  |  |  |  |  |  |"];

    assert.deepEqual(parser(str), [7,7,7,7,7,7,7,7,7]);
  });

  it("passes the 9th example", function() {
    var str = [" _  _  _  _  _  _  _  _  _ ",
               "|_||_||_||_||_||_||_||_||_|",
               "|_||_||_||_||_||_||_||_||_|"];

    assert.deepEqual(parser(str), [8,8,8,8,8,8,8,8,8]);
  });

  it("passes the 10th example", function() {
    var str = [" _  _  _  _  _  _  _  _  _ ",
               "|_||_||_||_||_||_||_||_||_|",
               " _| _| _| _| _| _| _| _| _|"];

    assert.deepEqual(parser(str), [9,9,9,9,9,9,9,9,9]);
  });

  it("passes the 11th example", function() {
